...
- **Acessível** - ARIA completo e navegação por teclado (Setas, Enter, Esc)
...
<div class="preview border rounded-lg p-10 flex items-center justify-center min-h-[200px]">
  <DropdownMenu placement="bottom-end">
    ...
    <DropdownContent class="w-56">
      <DropdownLabel>john@example.com</DropdownLabel>
      <DropdownSeparator />
...
Menu dropdown completo com múltiplas seções, ícones e navegação:
